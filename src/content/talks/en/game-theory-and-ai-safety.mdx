...
Two players choose to **cooperate** or **defect**. Defecting is always the "logical" choice, yet mutual defection is worse than mutual cooperation.
...
This sentence *is* the prisoner's dilemma. Each player reasons:

"Regardless of what the other does, I'm better off defecting."
...
Robert Axelrod invited experts to submit strategies for a **repeated** prisoner's dilemma. The winner was the simplest program: **Tit-for-Tat**.
...
**Generous Tit-for-Tat**: occasionally ignore a defection (~10% of the time) to restore cooperation.
...
|---|---|---|
| Always Defect | The Predator | Wins early, starves as cooperators die out |
| Always Cooperate | The Sucker | Gets exploited and goes extinct |
| Tit-for-Tat | The Just Player | Winner — robust, promotes mutual benefit |
| Generous Tit-for-Tat | The Peacemaker | Survives noise, prevents endless conflict |
