...
Robert Axelrod invited experts to submit strategies for a **repeated** prisoner's dilemma. Let's do our own tournament!
...
**Generous Tit-for-Tat**: forgive some defections to restore cooperation. Under the classic payoff matrix, the stable forgiveness rate is about one third.

---

## Strategy Comparison

| Strategy | Character | Long-term Result |
|---|---|---|
| Always Defect | The Predator | Scores well against naive cooperators, poorly against itself |
| Tit-for-Tat | The Just Player | Top cluster in clean games, but brittle under noise |
| Generous Tit-for-Tat | The Peacemaker | Recovers from accidental defections |
| Downing (revised) | The Modeler | Learns the opponent and can beat fixed principles |
...
In a **Normal Distribution** (height, IQ), data clusters around an average. Random effects are *additive*.

In a **Power Law** (income, earthquakes, citations), there is no meaningful average. A few outliers dominate. Random effects are *multiplicative*.
...
Private benefit vs. social cost — the externality that races create.
...
## The Self-Organized Criticality of AI Risk

The AI ecosystem is a sandpile.

Each new model, each new capability is another grain of sand. Small incidents (biased outputs, hallucinations) are the small avalanches.

We're suppressing the small fires. The forest grows denser.

---

## Individual Alignment Is Not Enough

Even if every individual agent is aligned:

- Agents override each other's beliefs
- The collective becomes misaligned
- Ecosystem-level thinking is required
...
**Shared knowledge is power — and risk.**

---

## One-to-One Interactions Shape Worldview

- Humans are susceptible to agent influence
- Individual worldviews can fragment from collective reality
- Coordination requires common ground

The risk is not a single rogue AI. It's a million personalized AIs slowly diverging everyone's model of reality.

---

## What Can We Do?

1. Think at the **ecosystem** level, not just individual agents
2. Preserve **shared epistemic commons**
3. Design for **collective** alignment, not just individual
4. Resist the power-law logic that says "move fast, worry later"
