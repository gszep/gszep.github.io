...
Here the literature is cleaner. Technology accelerates at rate $a$. Institutions — education, labour law, tax-and-transfer, retraining, licensing, liability — absorb the acceleration at some rate $\iota$. When $a$ outruns $\iota$, the positive gap integrates into a loss of labour share. Capital captures the un-absorbed surplus. Labour bears the adjustment. Once $\iota$ catches up, the valley closes. Until then, it deepens.

This is an institutional-lag theorem<sup><a href="#ref-7">7</a></sup>, not an uncertainty principle, though it has the flavour of one. When technology wins the race against education and institutions, inequality rises. When they catch up, it falls. Post-1980 technology has been winning. The skill premium has widened for forty years and counting. The valley is not hypothetical — it is already here at its current depth. The question is whether we are making it deeper.
