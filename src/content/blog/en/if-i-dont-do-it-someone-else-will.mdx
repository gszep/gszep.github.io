...
You can see the shape in the historical record. The plot below puts productivity and real wages on the same axis, for three cases economists treat as canonical. The red region between the two lines is the valley: the integrated gap between what the economy produced and what flowed to labour.

<figure>
  <ValleyShape />
  <figcaption>Three valleys from the historical record, plus the range of AI scenarios from the literature. Productivity (black) and real wages (blue); the red region between them is the valley. Select a scenario to compare shapes; drag the sliders for custom parameters.</figcaption>
</figure>

Three shapes to sit with.

**Britain, 1780 to 1840.** Output per worker rose forty-six percent. Real wages rose twelve<sup><a href="#ref-8">8</a></sup>. The gap — sixty years wide, persistent at roughly half a percentage point per year — is known as Engels' pause<sup><a href="#ref-9">9</a></sup>. The pause ended only after factory acts, union recognition, public education, and franchise expansion. Institutional catch-up, not market magic. It is roughly the worst-case version of the thing Friedman's essay calls the valley<sup><a href="#ref-10">10</a></sup>.

**The United States, 1970 onward.** Productivity and real median wages tracked each other for thirty years after the war; from around 1973 they split, and the split has widened. The labour share of the nonfarm business sector fell from roughly sixty-four percent in 1980 to fifty-eight percent by the late 2010s<sup><a href="#ref-11">11</a></sup>. The valley is shallower than Engels's but longer, still open, and disproportionately borne by manufacturing and routine-cognitive workers.

**Russia and the former Soviet bloc, 1989 to 2000.** Real GDP per capita roughly halved. Real wages collapsed by two-thirds. Male life expectancy dropped from sixty-five to fifty-seven<sup><a href="#ref-12">12</a></sup>. Excess mortality over the decade is estimated at several million, driven by deaths of despair under collapsed institutions. The valley closed after 2000 only because some institutions were partially rebuilt. The generation that lived through the transition did not.

Three shapes of the same phenomenon. Wide and shallow. Long and persistent. Narrow and catastrophic. The AI projections, charted on the same axes, sit among them — the modest scenario resembling US deindustrialisation imposed faster, the radical scenario deeper than anything in the historical record while compressed into fewer years.

Two things are worth noticing before we leave the figure.

One: the gap does not close by itself. Every historical closure was paid for by a specific political-economy programme — factory acts, franchise expansion, unions, the welfare state, public education. Every future closure has to be paid for the same way. The institutional curve in the figure rises only because we have drawn it that way.
